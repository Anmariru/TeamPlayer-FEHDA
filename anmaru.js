let ourTeam = {
	...
	members: [
      ...
      colors: {
        ...
        secondary: {red: 204, green: 153, blue: 0} //chartreuse
      }
		},
		{
			name: "Euron",
      ...
      codingLevel: { //TASK
        ...
        seniority: "Junior"
			...
			colors: {
        primary: {red: 255, green: 153, blue: 0}, //dotter
...
let oldestMember = ourTeam.members[0]; //Franzi 1994 --> Heidelinde 1980
let youngestMember = ourTeam.members[0]; //Franzi 1994 --> Euron 1998
...
console.log("The oldest member is: " + oldestMember.name);
...
for (let member of ourTeam.members) {
  if (member.location === "Vienna"){
    location.vienna += member.name + ", ";
  }
  else if (member.location === "Graz"){
    location.graz += member.name + ", ";
  }
  else if (member.location === "Moedling"){
    location.moedling += member.name + ", ";
  }
}
