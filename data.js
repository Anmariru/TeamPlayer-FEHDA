        ...
        favBooks: [
          {
            ...
            review:
              "Eragon is a story unlike every other stories about magic, dragons, elfes, dwarfs and humans fighting about pure power and evil.", //TASK
          },
          {
            title: "Tintenherz",
            ...
            review:
              "the story and idea behind this book-series is so unique, I never read a book like this ever again. It caught me from page 1 until the very end.", //TASK
          },
        ],
        favMovies: [
          {
            ...
            review:
              "This movie combines the power of imagination, family and the magic of the spirits in Japan in a calm and hypnotizing way.", //TASK
          },
          {
            title: "Naruto",
            year: 2002,
            ...
            review:
              "This serie made me laugh, made me cry and showed me, what true love to your younger brother can be. (And since i have a younger sister, i realy felt that on a different level.)", //TASK
          },
          {
            ...
            review:
              "Its an emotional, intense and truly great movie with an absolutly great vilian, so far one of the best Batman-movies.", //TASK
          },
          {
            ...
            review:
              "This movie is entertaining written in the Style of Quentin Tarantino. If you like his style, give this movie a try.", //TASK
          },
        ],
      },
      codingLevel: {
        ...
        favBooks: [
          {
            ...
            characters: ["Napoleon"],
            review:
              "each member must write why they like that book, movie, or song and why they recommend it", //TASK
          },
          {
        ...
        favBooks: [
          {
            ...
            review:
              "I like it, because it changed or open my mind and gives me new perspectives by myself.", //TASK
          },
          {
            ...
            review:
              "I love Australia and the story let me remind about the wounderful land and culture.", //TASK
          },
        ],
        favMovies: [
          {
          ...
          },
          {
            ...
            genres: ["Action"],
            review:
              "I like it, because there are fantastic stars in it and it is a thrilling movie ", //TASK
          },
          {
            ...
            review:
              "I like it, because it is a very good animation movie with a sweet heart story", //TASK
          },
          {
            title: "Top Gun",
            year: 1986,
            ...
            genres: ["Action"],
            review:
              "I like the mix between the aircraft, sunny boys and lovestorys in one movie.", //TASK
          },
        ],
      },
      codingLevel: {
        ...
        favBooks: [
          {
            ...
            review:
              "I love this book because it combines magic, music and a little bit of romance.", //TASK
          },
          {
            title: "The Atlas Six",
            author: "Olivie Blake",
            ...
            review:
              "This book is one of my favorites because until the end it is really thrilling and full of surprises.", //TASK
          },
        ],
        favMovies: [
          {
...
//TASK average Age 1
let averageAge = 0;
//option: man kann auch mit einer weiteren variable arbeiten und sich dann das aktuelle jahr holen
...
let tempOldestMember = ourTeam.members[0]; //Franzi 1994 --> Heidelinde 1980
let tempYoungestMember = ourTeam.members[0]; //Franzi 1994 --> Euron 1998

for (const member of ourTeam.members) {
  if (member.birthday.year <= tempOldestMember.birthday.year) {
    tempOldestMember = member;
  } else if (member.birthday.year > tempYoungestMember.birthday.year) {
...
//console.log ( "The youngest member is :" + youngestMember.name);
...
for (let i = 0; i < ourTeam.members.length; i++){
	if (tempYoungestMember.birthday.year < ourTeam.members[i].birthday.year){
		tempYoungestMember = ourTeam.members[i];
	}
	else if (tempOldestMember.birthday.year > ourTeam.members[i].birthday.year){
		tempOldestMember = ourTeam.members[i];
	}
}
...
//console.log ( "The youngest member is :" + youngestMember1); //console.log ("The oldest member is: ",oldestmember)
...
for (let member of ourTeam.members) {
  for (let movie of member.favorites.favMovies)
    for (let genre of movie.genres) {
      if (genre in commonGenres) {
        //if genre isn there add value +1
        commonGenres[genre] += 1; //adds the first key/value pair
      } else {
        //if the genre isn't already there, add genre and value +1
